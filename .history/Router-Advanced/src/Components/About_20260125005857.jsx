...
const About = () => {
  ...
  return (
    <div>
        <button className='px-4 py-2 bg-blue-600 text-white rounded active:scale-97 cursor-pointer hover:bg-blue-700' onClick={navigate}>Return to home page</button>
