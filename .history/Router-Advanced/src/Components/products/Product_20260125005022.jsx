...
const Product = () => {
    ...
    return (
        <div>
            ...
            <Link className='px-3 py-2 rounded hover:bg-gray-700 hover:text-white' to='/kids'>Kids</Link>
            <Link className='px-3 py-2 rounded hover:bg-gray-700 hover:text-white' to='dynamicrouter/123'>Dynamic Router</Link>
